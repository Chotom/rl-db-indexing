...
[2] o_orderstatus   CHAR(1)        NOT NULL,\n
[3] o_totalprice    DECIMAL(15, 2) NOT NULL,\n
[4] o_orderdate     DATE           NOT NULL,\n
[5] o_orderpriority CHAR(15)       NOT NULL,\n
[6] o_clerk         CHAR(15)       NOT NULL,\n
[7] o_shippriority  INTEGER        NOT NULL,\n
[8] o_comment       VARCHAR(79)    NOT NULL
"""

LINEITEM_QUOTE_INDEX_LIST = [8, 9, 10, 11, 12, 13, 14, 15]
"""Lineitem table values order:\n
